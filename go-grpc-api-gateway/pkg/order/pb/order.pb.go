...
const file_pkg_order_pb_order_proto_rawDesc = "" +
	"\n" +
	"\x18pkg/order/pb/order.proto\x12\x05order\"f\n" +
	...
	"\fOrderService\x12F\n" +
	"\vCreateOrder\x12\x19.order.CreateOrderRequest\x1a\x1a.order.CreateOrderResponse\"\x00B\x10Z\x0e./pkg/order/pbb\x06proto3"

var (
	file_pkg_order_pb_order_proto_rawDescOnce sync.Once
	file_pkg_order_pb_order_proto_rawDescData []byte
)

func file_pkg_order_pb_order_proto_rawDescGZIP() []byte {
	file_pkg_order_pb_order_proto_rawDescOnce.Do(func() {
		file_pkg_order_pb_order_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_pkg_order_pb_order_proto_rawDesc), len(file_pkg_order_pb_order_proto_rawDesc)))
	})
...
func file_pkg_order_pb_order_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_pkg_order_pb_order_proto_rawDesc), len(file_pkg_order_pb_order_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   2,
			NumExtensions: 0,
			NumServices:   1,
