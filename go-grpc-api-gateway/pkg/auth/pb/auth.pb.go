...
const file_pkg_auth_pb_auth_proto_rawDesc = "" +
	"\n" +
	"\x16pkg/auth/pb/auth.proto\x12\x04auth\"C\n" +
...
var (
	...
	file_pkg_auth_pb_auth_proto_rawDescData []byte
)

func file_pkg_auth_pb_auth_proto_rawDescGZIP() []byte {
	file_pkg_auth_pb_auth_proto_rawDescOnce.Do(func() {
		file_pkg_auth_pb_auth_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_pkg_auth_pb_auth_proto_rawDesc), len(file_pkg_auth_pb_auth_proto_rawDesc)))
	})
