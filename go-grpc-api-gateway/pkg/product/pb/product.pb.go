...
const file_pkg_product_pb_product_proto_rawDesc = "" +
	"\n" +
	"\x1cpkg/product/pb/product.proto\x12\aproduct\"h\n" +
	...
	"\rDecreaseStock\x12\x1d.product.DecreaseStockRequest\x1a\x1e.product.DecreaseStockResponse\"\x00B\x12Z\x10./pkg/product/pbb\x06proto3"

var (
	file_pkg_product_pb_product_proto_rawDescOnce sync.Once
	file_pkg_product_pb_product_proto_rawDescData []byte
)

func file_pkg_product_pb_product_proto_rawDescGZIP() []byte {
	file_pkg_product_pb_product_proto_rawDescOnce.Do(func() {
		file_pkg_product_pb_product_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_pkg_product_pb_product_proto_rawDesc), len(file_pkg_product_pb_product_proto_rawDesc)))
	})
...
func file_pkg_product_pb_product_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_pkg_product_pb_product_proto_rawDesc), len(file_pkg_product_pb_product_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   7,
			NumExtensions: 0,
			NumServices:   1,
